...
function cabStyles() {
  document.getElementById("cab-styles")?.remove();
  ...
  style.textContent = `
    ...
    .cab-backdrop{position:fixed;inset:0;z-index:300001;background:rgba(0,0,0,.55);display:grid;place-items:center;padding:8px}.cab-dialog{width:calc(100vw - 16px);height:calc(100dvh - 16px);display:grid;grid-template-columns:minmax(0,1fr) clamp(300px,22vw,360px);background:#191c21;color:#e8edf4;border:1px solid rgba(255,255,255,.16);border-radius:8px;overflow:hidden}.cab-preview-pane{position:relative;min-width:0;min-height:0;background:#05070a;overflow:hidden}.cab-preview-pane>img{position:absolute!important;inset:0!important;display:block!important;width:100%!important;height:100%!important;max-width:none!important;max-height:none!important;margin:auto!important;object-fit:contain!important;object-position:center center!important;background:#05070a}.cab-detail-pane{min-height:0;padding:10px 12px;overflow:auto;font-size:11px}.cab-detail-header{display:flex;justify-content:space-between;align-items:start;gap:8px;margin-bottom:8px}.cab-detail-header h3{margin:0 0 2px;font-size:15px}.cab-detail-header p{margin:0;color:#aeb7c4}.cab-section{border-top:1px solid rgba(255,255,255,.1);padding:8px 0}.cab-section h4{margin:0 0 6px;font-size:11px;color:#d6dde8}.cab-field-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.cab-field{min-width:0;border:1px solid rgba(255,255,255,.1);border-radius:6px;background:#11151b;padding:6px}.cab-field span{display:block;color:#95a0af;font-size:9px;margin-bottom:2px}.cab-field strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:600}.cab-chip-list{display:flex;flex-wrap:wrap;gap:5px}.cab-chip-list span{border:1px solid rgba(255,255,255,.14);border-radius:999px;background:#11151b;padding:3px 6px}.cab-chip-list button{min-height:18px;padding:0 4px;margin-left:4px}.cab-section label{display:block;color:#95a0af;font-size:9px;margin:6px 0 3px}.cab-curation-row{display:flex;gap:8px;flex-wrap:wrap}.cab-curation-row label{display:flex;align-items:center;gap:4px}.cab-inline-form{display:grid;grid-template-columns:1fr auto;gap:5px;margin:6px 0}.cab-detail-pane textarea{box-sizing:border-box;width:100%;min-height:52px;border:1px solid rgba(255,255,255,.14);border-radius:6px;background:#101318;color:#f4f7fb;padding:6px;font:inherit}.cab-subtle{color:#aeb7c4}.cab-related-section{margin-top:8px}.cab-related-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;margin-top:5px}.cab-related-grid button{min-height:0;padding:0;overflow:hidden}.cab-related-grid img{display:block;width:100%;height:60px;object-fit:contain}.cab-related-grid span{display:block;padding:3px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:9px}.cab-prompt-text,.cab-raw-json pre{max-height:140px;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere;background:#05070a;padding:8px;border-radius:6px;border:1px solid rgba(255,255,255,.08)}.cab-raw-json{border-top:1px solid rgba(255,255,255,.1);padding:8px 0}.cab-raw-json summary{cursor:pointer;color:#c8d1df}.cab-raw-json pre{max-height:220px}.cab-detail-header button{border:1px solid rgba(255,255,255,.14);border-radius:6px;background:#262b33;color:#f4f7fb;min-height:28px;padding:0 9px;cursor:pointer}@media(max-width:900px){.cab-dialog{grid-template-columns:1fr;height:calc(100dvh - 12px);width:calc(100vw - 12px)}.cab-preview-pane{min-height:58vh}.cab-field-grid,.cab-related-grid{grid-template-columns:1fr}}
  `;
