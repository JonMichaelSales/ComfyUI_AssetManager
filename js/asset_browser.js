...
function cabStyles() {
  ...
  style.textContent = `
    ...
    .cab-backdrop{position:fixed;inset:0;z-index:300001;background:rgba(0,0,0,.55);display:grid;place-items:center;padding:16px}.cab-dialog{width:min(1480px,calc(100vw - 32px));height:min(920px,calc(100vh - 32px));display:grid;grid-template-columns:minmax(0,1fr) clamp(330px,30vw,430px);background:#191c21;color:#e8edf4;border:1px solid rgba(255,255,255,.16);border-radius:8px;overflow:hidden}.cab-preview-pane{min-width:0;min-height:0;background:#05070a;display:grid;place-items:center;overflow:hidden}.cab-preview-pane>img{display:block;width:auto;height:auto;max-width:100%;max-height:100%;object-fit:contain;object-position:center;background:#05070a}.cab-detail-pane{min-height:0;padding:12px 14px;overflow:auto;font-size:12px}.cab-detail-header{display:flex;justify-content:space-between;align-items:start;gap:10px;margin-bottom:10px}.cab-detail-header h3{margin:0 0 2px;font-size:16px}.cab-detail-header p{margin:0;color:#aeb7c4}.cab-section{border-top:1px solid rgba(255,255,255,.1);padding:10px 0}.cab-section h4{margin:0 0 8px;font-size:12px;color:#d6dde8}.cab-field-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.cab-field{min-width:0;border:1px solid rgba(255,255,255,.1);border-radius:6px;background:#11151b;padding:7px}.cab-field span{display:block;color:#95a0af;font-size:10px;margin-bottom:2px}.cab-field strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:600}.cab-chip-list{display:flex;flex-wrap:wrap;gap:6px}.cab-chip-list span{border:1px solid rgba(255,255,255,.14);border-radius:999px;background:#11151b;padding:3px 7px}.cab-chip-list button{min-height:18px;padding:0 4px;margin-left:4px}.cab-section label{display:block;color:#95a0af;font-size:10px;margin:7px 0 3px}.cab-curation-row{display:flex;gap:10px;flex-wrap:wrap}.cab-curation-row label{display:flex;align-items:center;gap:5px}.cab-inline-form{display:grid;grid-template-columns:1fr auto;gap:6px;margin:7px 0}.cab-detail-pane textarea{box-sizing:border-box;width:100%;min-height:58px;border:1px solid rgba(255,255,255,.14);border-radius:6px;background:#101318;color:#f4f7fb;padding:7px;font:inherit}.cab-subtle{color:#aeb7c4}.cab-related-section{margin-top:10px}.cab-related-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin-top:6px}.cab-related-grid button{min-height:0;padding:0;overflow:hidden}.cab-related-grid img{display:block;width:100%;height:68px;object-fit:contain}.cab-related-grid span{display:block;padding:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:10px}.cab-prompt-text,.cab-raw-json pre{max-height:170px;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere;background:#05070a;padding:9px;border-radius:6px;border:1px solid rgba(255,255,255,.08)}.cab-raw-json{border-top:1px solid rgba(255,255,255,.1);padding:10px 0}.cab-raw-json summary{cursor:pointer;color:#c8d1df}.cab-raw-json pre{max-height:260px}.cab-detail-header button{border:1px solid rgba(255,255,255,.14);border-radius:6px;background:#262b33;color:#f4f7fb;min-height:30px;padding:0 10px;cursor:pointer}@media(max-width:900px){.cab-dialog{grid-template-columns:1fr;height:calc(100vh - 24px);width:calc(100vw - 24px)}.cab-preview-pane{min-height:52vh}.cab-field-grid,.cab-related-grid{grid-template-columns:1fr}}
  `;
